...
class TestCases(unittest.TestCase):
    ...
    def test_query_single(self):
        ...
        self.assertTrue(os.path.isfile(os.getcwd() + '/queries/gen:Otis.json'))
        self.assertTrue(os.path.isfile(os.getcwd() + '/recordings/Great_Bustard459281.mp3'))

    # Check if query can be made with multiple criteria
    def test_query_multiple(self):
        get_recordings(['gen:rhea', 'cnt:Brazil'])
        self.assertTrue(os.path.isfile(os.getcwd() + '/queries/gen:rhea_cnt:Brazil.json'))